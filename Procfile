...
web: sh -c 'cd decide &&  python manage.py makemessages -l es && python manage.py makemessages -l ca && python manage.py loaddata data.json && python manage.py compilemessages && gunicorn decide.wsgi --log-file -'
